...
Statechart could always use more documentation, whether as part of the
official Statechart docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.9, 3.10, 3.11, 3.12, 3.13
   and for PyPy. Check https://travis-ci.com/leighmck/statechart/pull_requests
